    ...
    <section id="products" className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-2 bg-teal-50 text-teal-600 font-medium rounded-full text-sm mb-4">
            تشكيلة متنوعة
          </span>
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            نوفر مجموعة شاملة من الأثاث المدرسي والمكتبي بأعلى معايير الجودة
          </p>
        </div>
